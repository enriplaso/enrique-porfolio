        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-top">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              With over 10 years of experience as Software Engineer, including 4
              years as a Full Stack Developer (Angular). I specialize in
              building high-demand, scalable applications capable of handling
              substantial traffic. I take pride in implementing optimizations
              that enhance performance and reliability.
            </p>

            <p className="text-muted-foreground">
              I'm passionate about system design and provide elegant solutions
              to complex problems, and I'm constantly learning new technologies
              and techniques.
            </p>
