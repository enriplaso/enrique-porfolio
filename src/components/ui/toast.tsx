...
type ToastPrimitiveActionProps = React.ComponentPropsWithoutRef<
  typeof ToastPrimitives.Action
>;

type ToastPrimitiveCloseProps = React.ComponentPropsWithoutRef<
  typeof ToastPrimitives.Close
>;

type ToastPrimitiveViewportProps = React.ComponentPropsWithoutRef<
...
const Toast = React.forwardRef<
  ...
  ToastPrimitiveRootProps & ToastVariants
